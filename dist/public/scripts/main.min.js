...
if(result===BREAK||result===RETURN)return result;}else 
...
return Object.defineProperty(_dereq_(29)('div'),'a',{get:function get(){return 7;}}).a!=7;});},
...
buffer=new $ArrayBuffer(byteLength);}else 
...
if(byteLength<0)throw RangeError(WRONG_LENGTH);}else 
{
byteLength=toLength($length)*BYTES;
if(byteLength+offset>$len)throw RangeError(WRONG_LENGTH);}

length=byteLength/BYTES;}else 
if(TYPED_ARRAY in data){
return fromList(TypedArray,data);}else 
{
...
hide(TypedArrayPrototype,'constructor',TypedArray);}else 
if(!$iterDetect(function(iter){
...
if(!LIBRARY&&!CORRECT_ITER_NAME)hide(TypedArrayPrototype,ITERATOR,$iterator);};}else 
...
e=1-eBias;}else 
if(e===eMax){
return m?NaN:s?-Infinity:Infinity;}else 
{
m=m+pow(2,mLen);
e=e-eBias;}
...
set(this,8,byteOffset,packF64,value,arguments[2]);}});}else 
...
hide(Typed.prototype,VIEW,true);}else 
CONSTR=false;}
...
$export($export.P+$export.F*_dereq_(34)(function(){
return new Date(NaN).toJSON()!==null||Date.prototype.toJSON.call({toISOString:function toISOString(){return 1;}})!==1;}),
'Date',{
...
(function (window, document) {
  ...
  var emailGenerator = regeneratorRuntime.mark(function emailGenerator(numEmails) {return regeneratorRuntime.wrap(function emailGenerator$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:if (!(
            numEmails > 0)) {_context.next = 6;break;}_context.next = 3;return (
              'test' + numEmails + '@test.com');case 3:
            numEmails--;_context.next = 0;break;case 6:case 'end':return _context.stop();}}}, emailGenerator, this);});



  // Take in number of unique emails to generate and return a list of 100,0000
  // using these set of unique emails.
  var getInputList = function getInputList(numEmails) {
    ...
    var input = [];
    var emails = [];var _iteratorNormalCompletion = true;var _didIteratorError = false;var _iteratorError = undefined;try {
      for (var _iterator = emailGenerator(numEmails)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {var _email = _step.value;
        emails.push(_email);}} catch (err) {_didIteratorError = true;_iteratorError = err;} finally {try {if (!_iteratorNormalCompletion && _iterator.return) {_iterator.return();}} finally {if (_didIteratorError) {throw _iteratorError;}}}


    var factor = Math.floor(INPUT_SIZE / numEmails);
    while (factor--) {
      input.push.apply(input, emails);}


    var reminder = INPUT_SIZE % numEmails;
    if (reminder) {var _iteratorNormalCompletion2 = true;var _didIteratorError2 = false;var _iteratorError2 = undefined;try {
        for (var _iterator2 = emailGenerator(reminder)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {var email = _step2.value;
          input.push(email);}} catch (err) {_didIteratorError2 = true;_iteratorError2 = err;} finally {try {if (!_iteratorNormalCompletion2 && _iterator2.return) {_iterator2.return();}} finally {if (_didIteratorError2) {throw _iteratorError2;}}}}
  ...
  var uniqueEmails = function uniqueEmails(emailList) {
    if (!Array.isArray(emailList)) {
      throw new Error('Invalid input passed. Expects a list to be passed');}

    var emails = {};
    return emailList.filter(function (email) {
      return emails[email] === undefined ? emails[email] = true : false;});};



  var init = function init(numEmails) {
    var input = getInputList(numEmails);
    input = shuffle(input);
  ...
  var clickHandler = function clickHandler(event) {
    ...
    // Read user input
    var count = parseInt(document.querySelector('#user-input').value, 10);
    var timer = init(count);
